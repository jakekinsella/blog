...
const Title = "2024 in Review";
const Subtitle = "Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit...";
const Path = "/post/2024-in-review";
const PostedAt = new Date(Date.parse("2024-12-16T17:02:36EST"));
...
const YearInReview2024: T = { Title, Subtitle, Path, PostedAt, Component };
export default YearInReview2024;
