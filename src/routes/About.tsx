  ...
  return (
    <Skeleton>
      <Article.T title="About">
        <Article.P>Hi, I'm Jake Kinsella. I'm a software architect + entrepreneur. At this point, I’ve been programming for the majority of my life. I learned my first programming language (Ruby) when I was in fourth grade and have been programming ever since.</Article.P>
        ...
        <Article.P>
          ...
          <a href="https://github.com/jakekinsella" target="_blank" rel="noreferrer">Personal GitHub</a><br />
          <a href="https://github.com/jake-kinsella" target="_blank" rel="noreferrer">Work GitHub</a>
        </Article.P>
